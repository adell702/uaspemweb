...
(1, 'Cuci + Setrika', 1, 7000),
(2, 'Cuci+Setrika Ekspres', 1, 14000),
(3, 'Cuci kering', 1, 6000),
(13, 'Cuci Karpet', 7, 10000),
(14, 'Setrika', 1, 5000),
(15, 'Bedcover', 5, 25000),
(16, 'Selimut tipis', 3, 10000);
...
(32, '2022-01-10', 2, 'Beli pemutih pakaian', NULL, 0, 'PG-0004', 50000);
...
INSERT INTO `tb_transaksi` (`id_laundry`, `pelangganid`, `userid`, `kd_jenis`, `tgl_terima`, `tgl_selesai`, `jml_kilo`, `catatan`, `totalbayar`, `status_pembayaran`, `status_pengambilan`) VALUES
('LD-0001', 5, 28, '1', '2022-01-09', '2022-01-12', 10, '5 baju, 5 celana levis', 70000, 1, 1),
('LD-0002', 3, 28, '2', '2022-01-09', '2022-01-10', 10, '10 kemeja, 2 celana training', 100000, 0, 0),
('LD-0003', 5, 28, '13', '2022-01-09', '2022-01-12', 20, 'Karpet 20kg', 200000, 1, 0),
('LD-0004', 9, 31, '12', '2022-01-09', '2022-01-11', 9, '14 kaus', 54000, 0, 0),
('LD-0005', 9, 31, '1', '2022-01-09', '2022-01-12', 5, '2 celana, 3 baju, 2 kaus', 35000, 1, 0);
...
(5, 'Fandi Aziz Pratama', 'Laki - laki', 'bandar', '0895392518654', '61da618d4343f.png'),
...
(09, 'adel', '$2y$10$3vW7VqHTaSpKnhlKL2Dd4OFzfV1oqGLw.vcqLIcDM7o7R.WADO00K', 'Adelia Puspita Saraswati', 'Perempuan', 'Jatimulya', '089652137823', 'adminadel.jpg', 'admin'),
(28, 'kasir1', '$2y$10$4sr89AaocI6DvBEF0jBfdeF3Q8/EY1/gwmLrodrSz1XUth.uJs3La', 'Eni', 'Perempuan', 'Jatimulya', '081234567890', 'kasireni.jpg', 'kasir'),
(31, 'Yuli', '$2y$10$R.KSk67SfxEwOm4B.nH9uegiyVyZmROF7/MSHYiuQ.9AmuZ3NU.aq', 'Yuli', 'Perempuan', 'MGT', '08965432145', '61dad24785895.jpg', 'kasir');
